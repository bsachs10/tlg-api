...
function openModal({title, filename}) {
    ...
    <div class="dl-modal-container">
        <h1>Deliver your download link to your inbox</h1>
        <div>Enter your email address to get <span id="dl-modal-filename">the file</span></div>
    ...
    document.getElementById('dl-modal-filename').classList.add("open");
    dl - modal - filename
