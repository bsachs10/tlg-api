...
function openModal({title, filename}) {
    ...
    <div class="dl-modal-container">
       ...
       <div class="dl-email-container field-list clear sqs-block-newsletter">
            <div id="" class="form-item field email required">
                <input class="dl-email" name="email" type="email" autocomplete="email" spellcheck="false" aria-required="true" placeholder="Email Address">
            </div>
            <div data-animation-role="button" class="form-button-wrapper form-button-wrapper--align-left">
                <input class="dl-submit btn btn--border theme-btn--primary-inverse sqs-button-element--primary" type="submit" value="Send to my inbox">
            </div>
        </div>
