...
function openModal({title, filename}) {
    ...
    <div class="dl-modal-container">
        ...
        <div id="dl-success" style="display: none">>
            ...
            <div class="sqsrte-large">And your promotions folder, your spam folder, and so on, and so on.</div>
        </div>
        <div id="dl-error" style="display: none">>
            <h2 style="text-align: center">Ruh roh</h2>
            <div class="sqsrte-large">An error occurred. If you don't receive the email, <a href="https://www.thelandinggroup.com/contact">contact us for assistance</a>.</div>
        </div>
