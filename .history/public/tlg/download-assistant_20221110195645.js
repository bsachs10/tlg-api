    ...
    <div class="dl-modal-container">
       ...
       <div class="field-list clear sqs-block-newsletter">
            <div id="" class="form-item field email required">
                <input class="newsletter-form-field-element field-element" id="dl-email" name="email" type="email" autocomplete="email" spellcheck="false" aria-required="true" placeholder="Email Address">
            </div>
